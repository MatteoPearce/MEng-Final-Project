...
class MaterialEvolution():
    ...
    base_workdir_path: str = "/users/mp1432/scratch/VAMPIRE_WORKDIR6" # working directory with materials folder and vampire binary "/home/matteo/Desktop/VAMPIRE_WORKDIR"
    base_materials_path: str = "/users/mp1432/scratch/VAMPIRE_WORKDIR6/Materials" # materials folder in working directory "/home/matteo/Desktop/VAMPIRE_WORKDIR/Materials"
    base_testdata_path: str = "/users/mp1432/scratch/VAMPIRE_TEST_RESULTS6" # results depot "/home/matteo/Desktop/VAMPIRE_TEST_RESULTS"
    input_file_parameters: dict = { "material:file" : ["Fe.mat"],#"Ni.mat"],
